...
cp -r ./deploy/* /app/deploy/

# Copy component directories
cp -r ./Nexvax-backend /app/opencex/backend
cp -r ./Nexvax-frontend /app/opencex/frontend
cp -r ./Nexvax-static /app/opencex/nuxt
cp -r ./Nexvax-JS-admin /app/opencex/admin
